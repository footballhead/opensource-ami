...
func dump(mpqDir, exePath, outputDir string) error {
	...
	case d1exe.DiabloVersionAlpha4:
		minisetInfos = []MinisetInfo{
			...
			// l4 minisets (extra).
			{addr: d1exe.L4Alpha4StairsUpAddr, tmxName: "alpha4_l4ustairs.tmx", dtype: enum.DTypeCatacombs},
			{addr: d1exe.L4Alpha4StairsDownAddr, tmxName: "alpha4_l4dstairs.tmx", dtype: enum.DTypeCatacombs},
		}
	}
